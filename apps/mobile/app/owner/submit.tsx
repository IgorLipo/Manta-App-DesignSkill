...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#2563eb', borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
  ...
  backLink: { fontSize: 14, color: '#2563eb', marginBottom: 16 },
